        ...
        sock.ev.on("connection.update", async (update) => {
            ...
            if (connection === "open") {
                ...
                try {
                    ...
                    const sessionId = "CRAZY-BOT~" + base64;

                    await sock.sendMessage(sock.user.id, { text: sessionId });

                    const successMsg = {
                        text:
                            `🚀 *CRAZY-BOT Session Created!*\n\n` +
                            `▸ *Never share* your session ID\n` +
                            `▸ Join our WhatsApp Channel\n` +
                            `▸ Report bugs on GitHub\n\n` +
                            `_Powered by CRAZY-BOT\n\n` +
                            `🔗 *Useful Links:*\n` +
                            `▸ GitHub: https://github.com/crazyhacker01gif\n` +
                            `▸ https://whatsapp.com/channel/0029VbCGeYHAe5VhjlX0xE2t`,
                        contextInfo: {
